    ...
    <div class="form-container">
        <div class="form-header">
            <div class="header-title">
                ...
                <p>Daftarkan pengguna baru ke dalam sistem dengan peran dan akses yang sesuai.</p>
            </div>
                ...
                <div class="form-grid">
                    <div class="form-section">
                        ...
                        <label class="label-group">
                            ...
                            <input type="email" name="email" placeholder="contoh@email.com" class="form-input"
                                value="{{ old('email') }}" required>
                        </label>

                        <label class="label-group">
                            <span class="label-text">Nomor Telepon</span>
                            <input type="text" name="phone" placeholder="0812xxxx" class="form-input"
                                value="{{ old('phone') }}" required>
                        </label>
                    </div>

                    <div class="form-section">
                        <h3 class="section-title">Akses Sistem</h3>
                        ...
                        <label class="label-group">
                            ...
                            <input type="password" name="password" placeholder="Min. 8 karakter" class="form-input"
                                required>
                            <p class="input-hint">Gunakan kombinasi huruf dan angka agar lebih aman.</p>
                        </label>
                    </div>
                </div>
